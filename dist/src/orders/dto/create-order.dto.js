...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 12.9, description: 'Se omitido, usa product.price' }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: '12', description: 'Número da comanda/mesa' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], CreateOrderDto.prototype, "tabNumber", void 0);
__decorate([
